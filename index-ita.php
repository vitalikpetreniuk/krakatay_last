...
<head>
	...
	<meta name="description" content="Localizza il tuo canale nelle 14 lingue più popolari con il più alto CPM per crescita di ricavi :white_check_mark: Conquista il mondo con il tuo canale Youtube!">
...
<body class="<?=$bodyclass?> index-ita">
	<div id="wrapper">
		<header class="kr-header" style="background-color: #1b1c1c;">
			<div class="container">
				...
				<div class="kr-header__right" data-aos="fade-left" data-aos-delay="700">
					...
					<ul>
						<li><a href="#about">Come funziona</a></li>
						<li><a href="#profit">Profitto</a></li>
						<li><a href="#audience">Audience</a></li>
						<li><a href="#infographics">Testimonianze</a></li>
		...
		<div class="main">
			<div class="kr-languages">
				<ul data-aos="slide-down" data-aos-delay="1500">
                    ...
                    <li><a href="/m_content/krakatau/index-ind.php">Hin</a></li>
			...
			<section id="welcome" class="kr-section kr-section_welcome">
				<div class="container">
					<h1 data-aos="fade-left" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Guadagni super <br class="vie-br1"><span>dal tuo</span><br> contenuto su Youtube</h1>
					<span class="only-for" style="display: block" data-aos="fade-right" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Offerta per canali<br> con 300 mila iscritti e oltre!</span>

					<div class="welcome-info" data-aos="zoom-in" data-aos-delay="1000">
						1 lingua = 1 fonte di guadagno<br>
						<span>14 lingue = 14 fonti di guadagno</span>
					</div>
					...
					<div class="welcome-map" data-aos="fade-in" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">
					    <div class="crm-info">
                            <div class="crm-content">
                                ...
                                <p>CPM per un milione di visualizzazioni<br> con annunci</p>
                            </div>
                        </div>
				...
				<div class="about-content">
					<div class="container">
						<div class="about-content__info" data-aos="fade-in">
							<span>Hai un canale con un contenuto interessante?</span>
							<h2>Grazie a <strong>Krakatau</strong> il tuo<br>
							contenuto sarà ascoltato,<br>
							visto, compreso e amato<br>
							in tutti i continenti!<br></h2>
						</div>
						<div class="about-content__boxes">
							<div class="about-content__box" data-aos="fade-up">
								<div class="box-header">
									...
									<h3 class="box-title">Traduzione</h3>
								</div>
								<div class="box-content">
									<ul>
										<li>Analisi del potenziale<br> del tuo contenuto</li>
										<li>Verifica della competitività<br> nelle altre lingue</li>
										<li>Creazione di una strategia<br> per il lancio di nuovi canali</li>
									</ul>
								</div>
							</div>
							<div class="about-content__box" data-aos="fade-up">
								<div class="box-header">
									...
									<h3 class="box-title">Doppiaggio</h3>
								</div>
								<div class="box-content">
									<ul>
										<li>Creazione di una trascrizione<br> del video</li>
										<li>Traduzione e localizzazione<br> dei copioni</li>
										<li>Ricerca delle<br> voci migliori</li>
									</ul>
								</div>
							</div>
							<div class="about-content__box" data-aos="fade-up">
								...
								<div class="box-content">
									<ul>
										<li>Adattamento del video<br> alle nuove lingue</li>
										<li>Creazione di video unici per<br> gli algoritmi di YouTube</li>
										<li>Aggiunta di nuovi elementi<br> audio e video</li>
									</ul>
								</div>
							</div>
							<div class="about-content__box" data-aos="fade-up">
								<div class="box-header">
									...
									<h3 class="box-title">Pubblicazione</h3>
								</div>
								<div class="box-content">
									<ul>
										<li>Analisi delle migliori<br> impostazioni per la pubblicazione</li>
										<li>Uso di schermate<br> finali e playlist</li>
										<li>Raccolta di nuvole di<br> etichette per ogni lingua</li>
									</ul>
								</div>
							</div>
							<div class="about-content__box" data-aos="fade-up">
								<div class="box-header">
									...
									<h3 class="box-title">Promozione</h3>
								</div>
								<div class="box-content">
									<ul>
										<li>Uso del miglior approccio<br> per finire nella sezione consigliati</li>
										<li>Dirigiamo traffico da<br> altri canali attivi</li>
										<li>Uso di AdWords e<br> altre piattaforme</li>
									</ul>
								</div>
							</div>
							<div class="about-content__box" data-aos="fade-up">
								<div class="box-header">
									...
									<h3 class="box-title">Analisi</h3>
								</div>
								<div class="box-content">
									<ul>
										<li>Definizione della migliore<br> strategia di promozione</li>
										<li>Scelta del miglior<br> contenuto per la traduzione</li>
										<li>Uso di statistiche sull’aumento<br> di visualizzazioni</li>
									</ul>
								</div>
							</div>
						</div>
			...
			<section id="profit" class="kr-section kr-section_profit" data-aos="fade-in">
				<div class="container">
					<h2>Scopri il ricavo generato dal tuo contenuto<br class="ita-br1"> una volta tradotto in altre lingue</h2>
					<h3>Calcolatore del ricavo per il canale YouTube</h3>

					<div class="profit-calculator" data-aos="zoom-in">
						<div class="pc-quantity">
							<span class="h4">Numero di visualizzazioni con annunci<br> su ogni canale</span>
							<div class="range-nav">
						...
						<div class="pc-languages">
							<ul>
								<li><span class="pc-lang-title">Inglese</span><span class="pc-lang-price" data-price="3900">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Giapponese</span><span class="pc-lang-price" data-price="3600">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Francese</span><span class="pc-lang-price" data-price="3300">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Tedesco</span><span class="pc-lang-price" data-price="3200">$<span></span>*</span></li>
								...
								<li><span class="pc-lang-title">Cinese</span><span class="pc-lang-price" data-price="1500">$<span></span>*</span></li>
							</ul>
							<ul>
								<li><span class="pc-lang-title">Spagnolo</span><span class="pc-lang-price" data-price="1100">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Portoghese</span><span class="pc-lang-price" data-price="1000">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Russo</span><span class="pc-lang-price" data-price="900">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Arabo</span><span class="pc-lang-price" data-price="800">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Vietnamita</span><span class="pc-lang-price" data-price="700">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Indonesiano</span><span class="pc-lang-price" data-price="600">$<span></span>*</span></li>
								<li><span class="pc-lang-title">Hindi</span><span class="pc-lang-price" data-price="400">$<span></span>*</span></li>
							</ul>
						</div>
						<div class="pc-subtotal"><span>Totale</span><span>$<span></span>*</span></div>
						<div class="pc-request"><button>Invia una richiesta</button></div>
					</div>
					<span>* Tutti i calcoli sono approssimativi<br> e dipendono dall’argomento del tuo canale</span>
				</div>
			</section>
			<section id="audience" class="kr-section kr-section_audience">
				<div class="container">
					...
					<div class="audience-info">
						<span><strong>Krakatau</strong> ha un’audience <br> di 3,8 miliardi<br class="ita-br1"> persone</span>
						<button>Invia una richiesta</button>
					</div>
				</div>
			</section>
			<section id="infographics" class="kr-section kr-section_infographics" data-aos="fade-in">
				<div class="container">
					<h2>Grafico di crescita dei<br> ricavi nella nuova lingua</h2>
					<span class="h4">Testimonianze reali dei nostri partner</span>
					...
					<div class="infographics-slider owl-carousel">
						<div class="item item-1" data-aos="zoom-in">
							<div class="is-author">
								...
								<span>Nascosto come richiesto<br> dal proprietario </span>
							</div>
							<div class="is-graphic">
								<span class="is-title">Intrattenimento</span>

								<picture loading="lazy" class="lazy">
								  <!-- <source srcset="img/infographics1-ita.webp" type="image/webp">  -->
								  <img src="img/infographics1-ita.png" alt="graphic">
								</picture>
						...
						<div class="item item-2" data-aos="zoom-in">
							...
							<div class="is-graphic">
								<span class="is-title">Fai Da Te</span>

								<picture loading="lazy" class="lazy">
								  <!-- <source srcset="img/infographics2-ita.webp" type="image/webp">  -->
								  <img src="img/infographics2-ita.png" alt="graphic">
								</picture>
						...
						<div class="item item-3" data-aos="zoom-in">
							...
							<div class="is-graphic">
								<span class="is-title">Bellezza</span>

								<picture loading="lazy" class="lazy">
								  <!-- <source srcset="img/infographics3-ita.webp" type="image/webp">  -->
								  <img src="img/infographics3-ita.png" alt="graphic">
								</picture>
						...
						<div class="item item-4" data-aos="zoom-in">
							...
							<div class="is-graphic">
								...
								<picture loading="lazy" class="lazy">
								  <!-- <source srcset="img/infographics4-ita.webp" type="image/webp">  -->
								  <img src="img/infographics4-ita.png" alt="graphic">
								</picture>
                    ...
                    <span class="is-chanels">
                        <span class="chanel">Guadagno dal canale principale</span>
                        <span class="chanel">Guadagno dai canali tradotti</span>
                    </span>
				</div>
			</section>
			<section id="contact-us" class="kr-section kr-section_contact-us" data-aos="fade-in">
                <div class="reasons">
                    <div class="container">
                        <span class="h2">Perché noi?</span>
                        <div class="reasons-info">
                            <p>Vasta esperienza nella traduzione professionale e nello sviluppo di canali stranieri</p>
                            <p>Noi copriamo tutte le spese di traduzione, localizzazione e promozione</p>
                            <p>Lavoriamo con il gruppo di lingue più redditizio che genera il massimo profitto</p>
                            <p>Forniamo statistiche trasparenti e mensili su tutti i canali</p>
                        </div>
                        ...
                        <div class="reasons-profit">
                            ...
                            <span>Otterrai</span>
                            <img class="lazy" data-src="img/text6.png" alt="profit" data-aos="zoom-in">
                            <span>senza spendere<br>
                                tempo o denaro</span>
                        </div>
                    </div>
                </div>
                <div class="contact-us">
                    <div class="container">
                        <span class="h2">Scrivici per</span>
                        <span class="h4">guadagnare di più</span>

						<form action="" method="post" novalidate>
                            <input type="text" name="name" id="input_name" placeholder="Il tuo nome" aria-label="name">
                            <div class="contact-social">
                                <div class="social-inputs">
                                    <input class="input-telegram active" type="text" name="telegram" placeholder="Il tuo Telegram" aria-label="telegram">
                                    <input class="input-whatsapp" type="text" name="whatsapp" placeholder="Il tuo Whatsapp" aria-label="whatsapp">
                                    <input class="input-messenger" type="text" name="messenger" placeholder="Il tuo Messenger" aria-label="messenger">
                                    <input class="input-instagram" type="text" name="instagram" placeholder="Il tuo Instagram" aria-label="instagram">
                                    <input class="input-skype" type="text" name="skype" placeholder="Il tuo Skype" aria-label="skype">
                                </div>
                            ...
                            <input type="email"  id="input_email" name="email" placeholder="Il tuo E-mail" aria-label="email">
                            <input type="text"  id="input_link" name="link" placeholder="Link al tuo canale YouTube" aria-label="youtube">

							<input type="submit" name="submit" onClick="return dataField(this.form);" value="Invia una richiesta">
                        </form>
                        <span>Garantiamo la riservatezza<br> delle tue informazioni</span>
                    </div>
                </div>
			</section>
		</div>
		...
		<div class="kr-request">
			<div class="kr-request-content">
				<span class="h2">Scrivici per <span>guadagnare di più</span></span>
				<form method="post" novalidate>
					<input type="text"   id="input_name2" name="name" placeholder="Il tuo nome">
					<!-- <input type="text"   id="input_messenger2" name="messenger" placeholder="Мессенджер"> -->
					<div class="contact-social">
                        <div class="social-inputs">
                            <input id="input_telegram2"  class="input-telegram active" type="text" name="telegram" placeholder="Il tuo Telegram" aria-label="telegram">
                            <input id="input_whatsapp2"  class="input-whatsapp" type="text" name="whatsapp" placeholder="Il tuo Whatsapp" aria-label="whatsapp">
                            <input id="input_messenger2" class="input-messenger" type="text" name="messenger" placeholder="Il tuo Messenger" aria-label="messenger">
                            <input id="input_instagram2" class="input-instagram" type="text" name="instagram" placeholder="Il tuo Instagram" aria-label="instagram">
                            <input id="input_skype2"     class="input-skype" type="text" name="skype" placeholder="Il tuo Skype" aria-label="skype">
                        </div>
                        <div class="social-links">
                            <ul>
                                <li class="link-telegram active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"/></svg></li>
					...
					<input type="text"  id="input_email2" name="email" placeholder="La tua E-mail" aria-label="email">
					<input type="text"   id="input_link2" name="link" placeholder="Link al tuo canale YouTube" aria-label="youtube">
					<input id="submit" type="submit" name="submit" onClick="return dataField2(this.form);" value="Invia una richiesta">
				</form>
			</div>
		</div>
		<div id="popup" class="kr-request request-thanks">
			<div class="kr-request-content-thanks">
				<span class="h2" style="margin:0;">Grazie! Ti contatteremo a breve</span>
			</div>
		</div>
        ...
        <div class="kr-lang-popup">
        	<div class="kr-lang-popup-content">
        		<ul>
        			<li><a href="/m_content/krakatau/index-eng.php">Inglese</a></li>
					<li><a href="/m_content/krakatau/index-spa.php">Spagnolo</a></li>
					<li><a href="/m_content/krakatau/index-hin.php">Hindi</a></li>
					<li><a href="/m_content/krakatau/index-ara.php">Arabo</a></li>
					<li><a href="/m_content/krakatau">Russo</a></li>
					<li><a href="/m_content/krakatau/index-fre.php">Francese</a></li>
					<li><a href="/m_content/krakatau/index-por.php">Portoghese</a></li>
					<li><a href="/m_content/krakatau/index-ind.php">Indonesiano</a></li>
					<li><a href="/m_content/krakatau/index-chi.php">Cinese</a></li>
					<li><a href="/m_content/krakatau/index-deu.php">Tedesco</a></li>
					<li><a href="/m_content/krakatau/index-jpn.php">Giapponese</a></li>

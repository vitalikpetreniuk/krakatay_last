...
<div id="wrapper">
            ...
            <div class="kr-header__right" data-aos="fade-left" data-aos-delay="700">
                <div class="kr-header__mainmenu">
                    <ul>
                        ...
                        <li><a href="#profit">Прибыль</a></li>
                        <li><a href="#audience">Аудитория</a></li>
                        <li><a href="#infographics">Кейсы</a></li>
    ...
    <div class="main">
        ...
        <section id="welcome" class="kr-section kr-section_welcome">
            <div class="container">
                <h1 data-aos="fade-left" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Сверхприбыль <span>вашего</span><br> YouTube-контента</h1>
                <span class="only-for" style="display: block" data-aos="fade-right" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Предложение для каналов<br> от 300К подписчиков!</span>

                <div class="welcome-info" data-aos="zoom-in" data-aos-delay="1000">
                    1 язык = 1 источник прибыли<br>
                    <span>14 языков = 14 источников прибыли</span>
                </div>
                ...
                <div class="welcome-map" data-aos="fade-in" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">
                    <div class="crm-info">
                        <div class="crm-content">
                            ...
                            <p>CPM за 1 миллион<br> коммерческих<br> показов</p>
                        </div>
                    </div>
                    ...
                    <!-- <img class="map-shadow" src="img/shadow_map.png" alt=""> -->
                    <?php require('img/image-php/image1.php') ?>
                </div>
            </div>
            ...
            <div class="about-content">
                <div class="container">
                    <div class="about-content__info" data-aos="fade-in">
                        <span>У вас есть канал с крутым контентом?</span>
                        <h2>Благодаря <strong>Krakatau</strong> ваш<br>
                            контент услышат, увидят,<br>
                            поймут и полюбят на<br>
                            всех континентах!<br></h2>
                    </div>
                    <div class="about-content__boxes">
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Переводим</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Анализируем потенциал<br> вашего контента</li>
                                    <li>Определяем конкурентность<br> на других языках</li>
                                    <li>Формируем стратегию<br> запуска новых каналов</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Озвучиваем</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Производим транскрибацию<br> голосов в видео</li>
                                    <li>Переводим и адаптируем<br> сценарии</li>
                                    <li>Подбираем лучшие<br> голоса для озвучивания</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Монтируем</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Адаптируем видеоряд<br> под новые языки</li>
                                    <li>Уникализируем видео под<br> алгоритмы YouTube</li>
                                    <li>Добавляем новые аудио-<br> и видеоэлементы</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Публикуем</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Анализируем наилучшие<br> параметры публикации</li>
                                    <li>Работаем с конечными<br> заставками и плейлистами</li>
                                    <li>Собираем облако тегов<br> по каждому языку</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Продвигаем</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Внедряем подход попадания<br> в рекомендованные</li>
                                    <li>Направляем трафик с других<br> активных каналов</li>
                                    <li>Работаем с AdWords и<br> другими площадками</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Анализируем</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Определяем наилучшую<br> стратегию продвижения</li>
                                    <li>Выбираем лучший ваш<br> контент для переводов</li>
                                    <li>Работаем с аналитикой<br> прироста просмотров</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <section id="profit" class="kr-section kr-section_profit" data-aos="fade-in">
            <div class="container">
                <h2>Узнайте, какой доход принесет ваш контент<br> на новых языках</h2>
                <h3>Калькулятор доходности YouTube-канала</h3>

                <div class="profit-calculator" data-aos="zoom-in">
                    <div class="pc-quantity">
                        <span class="h4">Количество коммерческих<br> воспроизведений на каждом канале</span>
                        <div class="range-nav">
                        ...
                        <input id="profit-input" type="text" class="js-range-slider" name="my_range" value="" aria-label="profit input" />
                    </div>
                    <div class="pc-languages">
                        <ul>
                            <li><span class="pc-lang-title">Английский</span><span class="pc-lang-price" data-price="3900">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Японский</span><span class="pc-lang-price" data-price="3600">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Французский</span><span class="pc-lang-price" data-price="3300">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Немецкий</span><span class="pc-lang-price" data-price="3200">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Корейский</span><span class="pc-lang-price" data-price="3000">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Итальянский</span><span class="pc-lang-price" data-price="2400">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Китайский</span><span class="pc-lang-price" data-price="1500">$<span></span>*</span></li>
                        </ul>
                        <ul>
                            <li><span class="pc-lang-title">Испанский</span><span class="pc-lang-price" data-price="1100">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Португальский</span><span class="pc-lang-price" data-price="1000">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Русский</span><span class="pc-lang-price" data-price="900">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Арабский</span><span class="pc-lang-price" data-price="800">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Вьетнамский</span><span class="pc-lang-price" data-price="700">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Индонезийский</span><span class="pc-lang-price" data-price="600">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Хинди</span><span class="pc-lang-price" data-price="400">$<span></span>*</span></li>
                        </ul>
                    </div>
                    <div class="pc-subtotal"><span>Итого</span><span>$<span></span>*</span></div>
                    <div class="pc-request"><button>Оставить заявку</button></div>
                </div>
                <span>* Все расчеты приблизительны, зависят<br> от тематики вашего контента</span>
            </div>
        </section>
        <section id="audience" class="kr-section kr-section_audience">
            <div class="container">
                ...
                <div class="audience-info">
                    <span>Аудитория <strong>Krakatau</strong><br> насчитывает 3,8 миллиарда<br> человек</span>
        ...
        <section id="infographics" class="kr-section kr-section_infographics" data-aos="fade-in">
            <div class="container">
                <h2>График роста доходов<br> на новых языках</h2>
                <span class="h4">Реальные кейсы наших партнеров</span>
                ...
                <div class="infographics-slider owl-carousel">
                    <div class="item item-1" data-aos="zoom-in">
                        <div class="is-author">
                            ...
                            <span>скрыто по просьбе  правообладателя </span>
                        </div>
                        <div class="is-graphic">
                            <span class="is-title">Entertainment</span>

                            <picture loading="lazy" class="lazy">
                                <!-- <source srcset="img/infographics1.webp" type="image/webp">  -->
                    ...
                    <div class="item item-2" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy" class="lazy">
                                <!-- <source srcset="img/infographics2.webp" type="image/webp">  -->
                    ...
                    <div class="item item-3" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy" class="lazy">
                                <!-- <source srcset="img/infographics3.webp" type="image/webp">  -->
                    ...
                    <div class="item item-4" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy" class="lazy">
                                <!-- <source srcset="img/infographics4.webp" type="image/webp">  -->
                ...
                <span class="is-chanels">
                        <span class="chanel">доход с основного YouTube-канала</span>
                        <span class="chanel">доход с переведенных YouTube-каналов</span>
                    </span>
            </div>
        </section>
            ...
            <div class="reasons">
                <div class="container">
                    ...
                    <div class="reasons-info">
                        <p>Большой опыт профессионального перевода и развития иностранных каналов</p>
                        <p>Берем на себя все расходы по переводу, адаптации контента и продвижению</p>
                        <p>Работаем с самыми прибыльными языковыми группами, которые приносят максимальный доход</p>
                        <p>Предоставляем прозрачную ежемесячную статистику по всем каналам</p>
                    </div>
                    ...
                    <div class="reasons-profit">
                        ...
                        <img class="lazy" data-src="img/profit.png" alt="profit" data-aos="zoom-in">
                        <span>без траты времени и<br>
                                финансовых вложений</span>
                    </div>
                </div>
            </div>
                    ...
                    <form action="" method="post" novalidate>
                        ...
                        <div class="contact-social">
                            <div class="social-inputs">
                                <input class="input-telegram active" type="text" name="telegram" placeholder="Ваш Telegram" aria-label="telegram">
                                <input class="input-whatsapp" type="text" name="whatsapp" placeholder="Ваш Whatsapp" aria-label="whatsapp">
                                <input class="input-messenger" type="text" name="messenger" placeholder="Ваш Messenger" aria-label="messenger">
                                <input class="input-instagram" type="text" name="instagram" placeholder="Ваш Instagram" aria-label="instagram">
                                <input class="input-skype" type="text" name="skype" placeholder="Ваш Skype" aria-label="skype">
                            </div>
                        ...
                        <input type="email"  id="input_email" name="email" placeholder="Ваш E-mail" aria-label="e-mail">
                        <input type="text"  id="input_link" name="link" placeholder="Ваш YouTube-канал" aria-label="youtube">

                        <input type="submit" name="submit" onClick="return dataField(this.form);" value="Оставить заявку">
                    </form>
                    <span>Мы гарантируем конфиденциальность<br> вашей информации</span>
                </div>
            </div>
        </section>
    </div>
        ...
        <div class="container">
            <div class="footer-top">
                ...
                <div class="footer-email">
                    <span>У вас оcтались вопросы?</span>
                </div>
            </div>
    ...
    <div class="kr-request">
        <div class="kr-request-content">
            ...
            <form method="post" novalidate>
                ...
                <div class="contact-social">
                    <div class="social-inputs">
                        <input id="input_telegram2"  class="input-telegram active" type="text" name="telegram" placeholder="Ваш Telegram" aria-label="">
                        <input id="input_whatsapp2"  class="input-whatsapp" type="text" name="whatsapp" placeholder="Ваш Whatsapp" aria-label="">
                        <input id="input_messenger2" class="input-messenger" type="text" name="messenger" placeholder="Ваш Messenger" aria-label="">
                        <input id="input_instagram2" class="input-instagram" type="text" name="instagram" placeholder="Ваш Instagram" aria-label="">
                        <input id="input_skype2"     class="input-skype" type="text" name="skype" placeholder="Ваш Skype" aria-label="">
                    </div>
                    <div class="social-links">
                        <ul>
                            <li class="link-telegram active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"/></svg></li>
                ...
                <input type="text"  id="input_email2" name="email" placeholder="E-mail" aria-label="">
                <input type="text"   id="input_link2" name="link" placeholder="Ваш YouTube-канал" aria-label="">
                <input id="submit" type="submit" name="submit" onClick="return dataField2(this.form);" value="Отправить">
            </form>
        </div>
    </div>
    <div id="popup" class="kr-request request-thanks">
        <div class="kr-request-content-thanks">
            <span class="h2" style="margin:0;">Obrigado! Iremos contactá-lo em breve.</span>
        </div>
    </div>

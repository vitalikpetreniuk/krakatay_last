...
<body class="<?=$bodyclass?> index-kor">
	<div id="wrapper">
        ...
        <div class="kr-lang-popup">
        	<div class="kr-lang-popup-content">
        		<ul>
        			<li><a href="/m_content/krakatau/index-eng.php">영어</a></li>
					<li><a href="/m_content/krakatau/index-spa.php">스페인어</a></li>
					<li><a href="/m_content/krakatau/index-hin.php">힌디어</a></li>
					<li><a href="/m_content/krakatau/index-ara.php">아랍어</a></li>
					<li><a href="/m_content/krakatau">러시아어</a></li>
					<li><a href="/m_content/krakatau/index-fre.php">프랑스어</a></li>
					<li><a href="/m_content/krakatau/index-por.php">포르투갈어</a></li>
					<li><a href="/m_content/krakatau/index-ind.php">인도네시아어</a></li>
					<li><a href="/m_content/krakatau/index-chi.php">중국어</a></li>
					<li><a href="/m_content/krakatau/index-deu.php">독일어</a></li>
					<li><a href="/m_content/krakatau/index-jpn.php">일본어</a></li>
					<li><a href="/m_content/krakatau/index-ita.php">이탈리아어</a></li>
					<li><a href="/m_content/krakatau/index-vie.php">베트남어</a></li>
	...
	function dataField(f) {
		...
		if(flag)	{
			...
			let dataString = 'name='+name+'&email='+email+'&link='+link;
			let messenger  = $('.input-messenger').val();
			if(messenger!=null) dataString += '&messenger='+messenger;
			let telegram  = $('.input-telegram').val();
			if(telegram!=null) dataString += '&telegram='+telegram;
			let whatsapp  = $('.input-whatsapp').val();
			if(whatsapp!=null) dataString += '&whatsapp='+whatsapp;
			let instagram  = $('.input-instagram').val();
			if(instagram!=null) dataString += '&instagram='+instagram;
			let skype  = $('.input-skype').val();
			if(skype!=null) dataString += '&skype='+skype;
			$.ajax({
				type: 'GET',
				url:'mail.php',
				data:dataString
	...
	function dataField2(f) {
       ...
       if((f.link.value == "") ) {
		...
		if(flag)	{
		    let name  = $("#input_name2").val();
			let email = $("#input_email2").val();
			let link  = $('#input_link2').val();
			let dataString = 'name='+name+'&email='+email+'&link='+link
			let messenger  = $('#input_messenger2').val();
			if(messenger!=null) dataString += '&messenger='+messenger;
			let telegram  = $('#input_telegram2').val();
			if(telegram!=null) dataString += '&telegram='+telegram;
			let whatsapp  = $('#input_whatsapp2').val();
			if(whatsapp!=null) dataString += '&whatsapp='+whatsapp;
			let instagram  = $('#input_instagram2').val();
			if(instagram!=null) dataString += '&instagram='+instagram;
			let skype  = $('#input_skype2').val();
			if(skype!=null) dataString += '&skype='+skype;
			if(messenger!=null) dataString += '&messenger='+messenger;
			$.ajax({
				type: 'GET',

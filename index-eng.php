...
<head>
    ...
    <meta name="description" content="Localize your content in the 14 most popular languages with the highest CPM for revenue growth :white_check_mark: Let your Youtube content conquer the whole world!">
...
<body class="en <?=$bodyclass?> index-eng">
<div id="wrapper">
            ...
            <div class="kr-header__right" data-aos="fade-left" data-aos-delay="700">
                <div class="kr-header__mainmenu">
                    <ul>
                        ...
                        <li><a href="#infographics">Cases</a></li>
    ...
    <div class="main">
        ...
        <section id="welcome" class="kr-section kr-section_welcome">
            <div class="container">
                <h1 data-aos="fade-left" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Super profits <span>of your</span><br> YouTube-content</h1>
                <span class="only-for" style="display: block" data-aos="fade-right" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">Offer for channels<br> from 300К subscribers!</span>

                <div class="welcome-info" data-aos="zoom-in" data-aos-delay="1000">
                    1 language = 1 revenue source<br>
                    <span>14 languages = 14 revenue sources</span>
                </div>
                ...
                <div class="welcome-map" data-aos="fade-in" data-aos-delay="1000" data-aos-anchor-placement="top-bottom">
                    <div class="crm-info">
                        <div class="crm-content">
                            ...
                            <p>CPM for a million<br> of commercial<br> views</p>
                        </div>
                    </div>
            ...
            <div class="about-content">
                <div class="container">
                    <div class="about-content__info" data-aos="fade-in">
                        <span>Do you have a channel with cool content?</span>
                        <h2>Thanks to <strong>Krakatau</strong> your<br>
                            content will be heard, seen,<br>
                            understood and loved<br>
                            on every continent!<br></h2>
                    </div>
                    <div class="about-content__boxes">
                        <div class="about-content__box" data-aos="fade-up">
                            ...
                            <div class="box-content">
                                <ul>
                                    <li>Analysing the potential<br> of your content</li>
                                    <li>Determining competitiveness<br> in other languages</li>
                                    <li>Creating a strategy<br> to launch new channels</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            ...
                            <div class="box-content">
                                <ul>
                                    <li>Creating a transcript<br> of the video</li>
                                    <li>Translating and localizing<br> the scripts</li>
                                    <li>Finding the<br> best voices</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            ...
                            <div class="box-content">
                                <ul>
                                    <li>Adapting the video<br> for new languages</li>
                                    <li>Creating unique videos<br> for YouTube algorithms</li>
                                    <li>Adding new audio<br> and video elements</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            ...
                            <div class="box-content">
                                <ul>
                                    <li>Analysing the best<br> settings for publishing</li>
                                    <li>Working with end<br> screens and playlists</li>
                                    <li>Gathering tag clouds<br> for each language</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            ...
                            <div class="box-content">
                                <ul>
                                    <li>Implementing the best approach&nbsp;to reach the recommended section</li>
                                    <li>Directing traffic from<br> other active channels</li>
                                    <li>Working with AdWords<br> and other platforms</li>
                                </ul>
                            </div>
                        </div>
                        <div class="about-content__box" data-aos="fade-up">
                            <div class="box-header">
                                ...
                                <h3 class="box-title">Analyzing</h3>
                            </div>
                            <div class="box-content">
                                <ul>
                                    <li>Determining the best<br> promotion strategy</li>
                                    <li>Choosing the best<br> content for translation</li>
                                    <li>Working with views<br> growth analytics</li>
                                </ul>
                            </div>
                        </div>
                    </div>
        ...
        <section id="profit" class="kr-section kr-section_profit" data-aos="fade-in">
            <div class="container">
                <h2>Find out what revenue will your content generate when<br> translated into other languages</h2>
                <h3>Revenue calculator for the YouTube-channel</h3>

                <div class="profit-calculator" data-aos="zoom-in">
                    <div class="pc-quantity">
                        <span class="h4">Number of commercial views on each channel</span>
                        <div class="range-nav">
                    ...
                    <div class="pc-languages">
                        <ul>
                            <li><span class="pc-lang-title">English</span><span class="pc-lang-price" data-price="3900">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Japanese</span><span class="pc-lang-price" data-price="3600">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">French</span><span class="pc-lang-price" data-price="3300">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">German</span><span class="pc-lang-price" data-price="3200">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Korean</span><span class="pc-lang-price" data-price="3000">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Italian</span><span class="pc-lang-price" data-price="2400">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Chinese</span><span class="pc-lang-price" data-price="1500">$<span></span>*</span></li>
                        </ul>
                        <ul>
                            <li><span class="pc-lang-title">Spanish</span><span class="pc-lang-price" data-price="1100">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Portuguese</span><span class="pc-lang-price" data-price="1000">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Russian</span><span class="pc-lang-price" data-price="900">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Arabic</span><span class="pc-lang-price" data-price="800">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Vietnamese</span><span class="pc-lang-price" data-price="700">$<span></span>*</span></li>
                            <li><span class="pc-lang-title">Indonesian</span><span class="pc-lang-price" data-price="600">$<span></span>*</span></li>
                    ...
                    <div class="pc-request"><button>Send a request</button></div>
                </div>
                <span>* All calculations are approximate and depend<br> on the topic of your content</span>
            </div>
        </section>
        <section id="audience" class="kr-section kr-section_audience">
            <div class="container">
                ...
                <div class="audience-info">
                    <span><strong>KRAKATAU</strong> has an audience<br> of 3,8 billion people</span>
        ...
        <section id="infographics" class="kr-section kr-section_infographics" data-aos="fade-in">
            <div class="container">
                <h2>New language revenue<br> growth chart</h2>
                <span class="h4">Real cases of our partners</span>
                ...
                <div class="infographics-slider owl-carousel">
                    <div class="item item-1" data-aos="zoom-in">
                        <div class="is-author">
                            ...
                            <span>Hidden as per the request of the owner </span>
                        </div>
                        <div class="is-graphic">
                            <span class="is-title">Entertainment</span>

                            <picture loading="lazy">
                              <source srcset="img/infographics1-eng.webp" type="image/webp"> 
                              <img src="img/infographics1-eng.png" alt="graphic">
                            </picture>
                    ...
                    <div class="item item-2" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy">
                              <source srcset="img/infographics2-eng.webp" type="image/webp"> 
                              <img src="img/infographics2-eng.png" alt="graphic">
                            </picture>
                    ...
                    <div class="item item-3" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy">
                              <source srcset="img/infographics3-eng.webp" type="image/webp"> 
                              <img src="img/infographics3-eng.png" alt="graphic">
                            </picture>
                    ...
                    <div class="item item-4" data-aos="zoom-in">
                        ...
                        <div class="is-graphic">
                            ...
                            <picture loading="lazy">
                              <source srcset="img/infographics4-eng.webp" type="image/webp"> 
                              <img src="img/infographics4-eng.png" alt="graphic">
                            </picture>
                ...
                <span class="is-chanels">
                        <span class="chanel">Income from the main YouTube-channel</span>
                        <span class="chanel">Income from the translated YouTube-channels</span>
                    </span>
            </div>
        </section>
        <section id="contact-us" class="kr-section kr-section_contact-us" data-aos="fade-in">
            <div class="reasons">
                <div class="container">
                    <span class="h2">Why us?</span>
                    <div class="reasons-info">
                        <p>Extensive experience with professional translation and developing foreign channels</p>
                        <p>We cover all translation, localization and promotion expenses</p>
                        <p>Working with the most profitable language groups that generate maximum revenue</p>
                        <p>Providing transparent monthly statistics on all channels</p>
                    </div>

                    <div class="reasons-profit">
                        <span class="profit-arrow" data-aos="flip-down"><img src="img/green-arrow.png" alt="arrow"></span>
                        <span>You get</span>
                        <img class="lazy" data-src="img/profit-eng.png" alt="profit" data-aos="zoom-in">
                        <span>without spending time<br>
                                and money</span>
                    </div>
                </div>
            </div>
            <div class="contact-us">
                <div class="container">
                    <span class="h2">Write to us</span>
						...
						<form action="" method="post" novalidate>
                            ...
                            <div class="contact-social">
                                <div class="social-inputs">
                                    <input class="input-telegram active" type="text" name="telegram" placeholder="Your Telegram" aria-label="telegram">
                                    <input class="input-whatsapp" type="text" name="whatsapp" placeholder="Your Whatsapp" aria-label="whatsapp">
                                    <input class="input-messenger" type="text" name="messenger" placeholder="Your Messenger" aria-label="messenger">
                                    <input class="input-instagram" type="text" name="instagram" placeholder="Your Instagram" aria-label="instagram">
                                    <input class="input-skype" type="text" name="skype" placeholder="Your Skype" aria-label="skype">
                                </div>
                            ...
                            <input type="email"  id="input_email" name="email" placeholder="Your E-mail" aria-label="e-mail">
                            <input type="text"  id="input_link" name="link" placeholder="Your YouTube-channel" aria-label="youtube">

							<input type="submit" name="submit" onClick="return dataField(this.form);" value="Send a request">
                        </form>
                        <span>We guarantee confidentiality<br> of your information<span>
                </div>
            </div>
        </section>
    </div>
        ...
        <div class="kr-request-content">
            <span class="h2">Write to us <span>to earn more</span></span>
				<form action="" method="post" novalidate>
                    ...
                    <div class="contact-social">
                        <div class="social-inputs">
                            <input  id="input_telegram2" class="input-telegram active" type="text" name="telegram" placeholder="Your Telegram" aria-label="telegram">
                            <input  id="input_whatsapp2" class="input-whatsapp" type="text" name="whatsapp" placeholder="Your Whatsapp" aria-label="wahtsapp">
                            <input  id="input_messenger2" class="input-messenger" type="text" name="messenger" placeholder="Your Messenger" aria-label="messenger">
                            <input  id="input_instagram2" class="input-instagram" type="text" name="instagram" placeholder="Your Instagram" aria-label="instagram">
                            <input  id="input_skype2" class="input-skype" type="text" name="skype" placeholder="Your Skype" aria-label="skype">
                        </div>
                        <div class="social-links">
                            <ul>
                                <li class="link-telegram active"><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 448 512"><path d="M446.7 98.6l-67.6 318.8c-5.1 22.5-18.4 28.1-37.3 17.5l-103-75.9-49.7 47.8c-5.5 5.5-10.1 10.1-20.7 10.1l7.4-104.9 190.9-172.5c8.3-7.4-1.8-11.5-12.9-4.1L117.8 284 16.2 252.2c-22.1-6.9-22.5-22.1 4.6-32.7L418.2 66.4c18.4-6.9 34.5 4.1 28.5 32.2z"/></svg></li>
					...
					<input type="text"  id="input_email2" name="email" placeholder="Your Email" aria-label="email">
					<input type="text"   id="input_link2" name="link" placeholder="Your YouTube-channel" aria-label="youtube">
					<input type="submit" name="submit" onClick="return dataField2(this.form);" value="Send">
				</form>
        </div>
    </div>
    <div id="popup" class="kr-request request-thanks">
        <div class="kr-request-content-thanks">
            <span class="h2" style="margin:0;">Thanks! We will get back to you soon.</span>
        </div>
    </div>
